...
setRes();
setColor();
wrReg(0x11, 24); //Earlier it had the value: wrReg(0x11, 12); New version works better for me :) !!!!
 /* Serial.begin(9600);
  //pinMode(8, OUTPUT); // for act break
  pinMode(9, OUTPUT); // for the act dir
  pinMode(10, OUTPUT); // for lift motor break
  pinMode(12, OUTPUT); // these two for DIR of motors
  pinMode(13, OUTPUT);
  digitalWrite(9, LOW);
...
void loop(){
 ...
 /* if(Serial.available() > 0){      // if data present, blink
    ...
    _delay_ms(30000); // check for how long the actuator moves...
    //digitalWrite(8, HIGH);
    //digitalWrite(9, HIGH);
    digitalWrite(10, LOW);
    digitalWrite(12, HIGH);
    digitalWrite(13, LOW);
    _delay_ms(58000); // check for how long it lifts
    digitalWrite(10,HIGH);
    _delay_ms(2000); // after lifting wait
    digitalWrite(10, LOW);
    digitalWrite(13, HIGH);
    digitalWrite(12, LOW);
     _delay_ms(6000); // check for how long it takes to put it down
     digitalWrite(10, HIGH);
   Serial.write('0');
    }
  */
